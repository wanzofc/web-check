...
const About = (): JSX.Element => {
  return (
    ...
    <AboutContainer>
      <Nav>
        <HeaderLinkContainer>
          <a target="_blank" rel="noreferrer" href="https://github.com/wanzbrayy"><Button>View on GitHub</Button></a>
        </HeaderLinkContainer>
      </Nav>
      ...
      <Section>
        ...
        <hr />
        <p>
          Web-Check is developed and maintained by <a target="_blank" rel="noreferrer" href="https://github.com/wanzbrayy">Alicia Sykes</a>.
          It's licensed under the <a target="_blank" rel="noreferrer" href="https://github.com/wanzbrayy">MIT license</a>,
          and is completely free to use, modify and distribute in both personal and commercial settings.<br />
          Source code and self-hosting docs are available on <a target="_blank" rel="noreferrer" href="https://github.com/wanzbrayy">GitHub</a>.
          If you've found this service useful, consider <a target="_blank" rel="noreferrer" href="https://github.com/wanzbrayy">sponsoring me</a> from $1/month,
      ...
      <Section>
        ...
        <a target="_blank" rel="noreferrer" href="https://github.com/wanzbrayy">
        ...
        <p>
          ...
          GitHub repository - <a target="_blank" rel="noreferrer" href="https://github.com/wanzbrayy">wanzbrayy</a>
        </p>
      ...
      <Heading as="h3" size="small" color={colors.primary}>License</Heading>
        <b>
          <a target="_blank" rel="noreferrer" href="https://github.com/wanzbrayy">Web-Check</a> is distributed under the MIT license,
          © <a target="_blank" rel="noreferrer" href="https://wanzofc.us.kg">WANZOFC</a> { new Date().getFullYear()}
        </b>
        <br />
